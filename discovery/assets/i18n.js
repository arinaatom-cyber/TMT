...
(function () {
  ...
  const T = {
    ...
    th_data: "Данные",
      ...
      cohorts_lead: "Europe PMC + text mining абстрактов: пациенты, N, омики, TMT",
      cohorts_method: "text mining · Europe PMC",
      cohorts_note: "Отбор: human proteomics/phosphoproteomics, крупные когорты (N≥50 из абстракта или large-scale/multi-omics). PMID из каталога атласа исключены. N извлекается regex из абстракта — проверяйте вручную.",
      ...
      card_cohorts_desc: "Свежие статьи с большими patient cohorts: протеомика, фосфо-, мульти-омика. Text mining абстрактов.",
    },
    en: {
      brand_title: "Sirius Human TMT Proteome Atlas",
      brand_sub: "Discovery · QC · read-only catalog",
    ...
    th_data: "Data",
      ...
      cohorts_lead: "Europe PMC + abstract text mining: patients, N, omics layers, TMT",
      cohorts_method: "text mining · Europe PMC",
      cohorts_note: "Selection: human proteomics/phosphoproteomics, large cohorts (N≥50 from abstract or large-scale/multi-omics). Atlas PMIDs excluded. N is regex-extracted — verify manually.",
      ...
      card_cohorts_desc: "Recent papers with large patient cohorts: proteomics, phospho-, multi-omics. Abstract text mining.",
    },
  };
