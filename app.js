...
const ANATOMY={
  /* HEAD (y=20–95) */
  Brain:           {pos:{x:240, y: 42}, side:'R', size:36, emoji:'1f9e0', z:1},
  Pituitary:       {pos:{x:240, y: 58}, side:'R', size:0,  z:3, d:
    'M 234 56 Q 240 53 246 56 Q 247 61 240 63 Q 233 61 234 56 Z'},
  ...
  Salivary_Gland:  {pos:{x:240, y: 80}, side:'R', size:0,  z:3, d:
    'M 216 74 Q 210 70 214 66 Q 222 64 226 70 Q 224 78 218 79 Z '+
    'M 264 74 Q 270 70 266 66 Q 258 64 254 70 Q 256 78 262 79 Z '+
    'M 226 88 Q 223 91 226 94 Q 230 92 228 88 Z '+
    'M 254 88 Q 257 91 254 94 Q 250 92 252 88 Z'},
  ...
  Esophagus:       {pos:{x:248, y:178}, side:'L', size:0,  z:1, d:
    'M 238 130 L 244 130 L 246 214 Q 248 222 252 228 L 254 232 L 256 236'},
  ...
  Heart:           {pos:{x:252, y:184}, side:'R', size:0,  z:3, d:
    'M 252 172 Q 244 170 242 182 Q 242 192 250 200 L 256 206 Q 264 194 264 182 Q 262 172 252 172 Z'},
  ...
  /* UPPER ABDOMEN — compact proportions inside torso */
  Liver:           {pos:{x:204, y:246}, side:'L', size:0,  z:2, d:
    'M 188 230 Q 182 246 184 262 Q 190 274 204 278 Q 222 280 234 270 Q 240 258 238 244 Q 232 234 218 230 Q 200 228 188 230 Z'},
  Stomach:         {pos:{x:262, y:252}, side:'R', size:0,  z:3, d:
    'M 254 236 L 258 236 L 260 248 Q 263 260 262 270 Q 258 276 252 276 Q 246 274 246 262 L 248 244 Q 249 238 254 236 Z'},
  Spleen:          {pos:{x:284, y:238}, side:'R', size:0,  z:2, d:
    'M 278 232 Q 286 230 288 240 Q 286 250 282 252 Q 276 244 278 234 Z'},
  Pancreas:        {pos:{x:254, y:274}, side:'R', size:0,  z:3, d:
    'M 258 268 Q 252 266 248 270 Q 244 276 248 282 Q 254 280 260 276 Q 262 270 258 268 Z'},

  Adrenal_Gland:   {pos:{x:240, y:250}, side:'R', size:0,  z:1, d:
    'M 178 252 Q 181 249 185 252 Q 183 256 179 256 Q 176 254 178 252 Z '+
    'M 295 252 Q 299 249 302 252 Q 304 256 300 256 Q 297 254 295 252 Z'},
  Kidney:          {pos:{x:240, y:258}, side:'L', size:0,  z:2, d:
    'M 176 252 Q 170 260 172 272 Q 178 280 184 278 Q 188 268 186 258 Q 182 250 176 252 Z '+
    'M 304 252 Q 310 260 308 272 Q 302 280 296 278 Q 292 268 294 258 Q 298 250 304 252 Z'},

  /* INTESTINES — horizontal coils + thin colon frame (not vertical stack) */
  Small_Intestine: {pos:{x:240, y:312}, side:'L', size:0,  z:3, d:
    'M 226 306 Q 234 300 242 306 Q 250 312 242 316 Q 234 314 226 306 Z '+
    'M 234 310 Q 242 306 250 310 Q 254 316 248 318 Q 240 316 234 310 Z '+
    'M 238 314 Q 246 312 252 316 Q 254 320 246 320 Q 238 318 238 314 Z'},
  Colon:           {pos:{x:240, y:314}, side:'R', size:0,  z:2, d:
    'M 216 300 Q 208 308 208 320 Q 212 330 228 332 Q 240 334 252 332 Q 268 330 272 320 Q 272 308 264 300 Q 252 296 240 296 Q 228 296 216 300 Z '+
    'M 224 304 Q 218 310 218 318 Q 222 324 240 326 Q 258 324 262 318 Q 262 310 256 304 Q 248 300 240 300 Q 232 300 224 304 Z'},

  /* PELVIS — below intestines (y >= 332) */
  Bladder:         {pos:{x:240, y:350}, side:'R', size:0,  z:4, d:
    'M 235 348 Q 240 345 245 348 Q 246 352 240 353 Q 234 352 235 348 Z'},
  Uterus:          {pos:{x:240, y:344}, side:'L', size:0,  z:3, d:
    'M 233 338 Q 240 334 247 338 L 249 350 Q 240 353 231 350 Z'},
  Ovary:           {pos:{x:240, y:340}, side:'R', size:0,  z:3, d:
    'M 216 338 Q 213 339 214 342 Q 217 343 218 340 Z '+
    'M 264 338 Q 267 339 266 342 Q 263 343 262 340 Z '+
    'M 218 340 L 224 338 M 262 340 L 256 338'},
  Cervix:          {pos:{x:240, y:356}, side:'L', size:0,  z:3, d:
    'M 237 354 L 243 354 L 242 358 L 238 358 Z'},
  Prostate:        {pos:{x:240, y:348}, side:'R', size:0,  z:3, d:
    'M 235 346 Q 240 342 245 346 Q 246 350 240 351 Q 234 350 235 346 Z'},
  Testis:          {pos:{x:240, y:380}, side:'L', size:0,  z:3, d:
    'M 235 376 Q 230 380 234 383 Q 240 383 241 380 Q 242 383 246 383 Q 250 380 246 376 Q 243 375 240 379 Q 237 375 235 376 Z'},
