...
const I18N={
  ru:{
    ...
    protFileHint:'файл Result Files из таблицы (часто .xlsx) в tmt-projects/Projects/PXD…',
    sheetCountHint:'Количество белков — из колонки Proteins Quantified в Google Sheets (не из файла).',
  ...
  en:{
    ...
    protFileHint:'Result Files column from the sheet (often .xlsx) in tmt-projects/Projects/PXD…',
    sheetCountHint:'Protein count is from column Proteins Quantified in Google Sheets (not from the file).',
