...
const ANATOMY={
  ...
  Esophagus:       {pos:{x:248, y:178}, side:'L', size:0,  z:1, d:
    'M 238 130 L 244 130 L 246 214 Q 248 222 252 228 L 254 230'},
  ...
  Liver:           {pos:{x:206, y:248}, side:'L', size:0,  z:2, d:
    'M 188 228 Q 180 246 182 264 Q 188 278 206 282 Q 226 284 240 272 Q 248 258 246 242 Q 238 232 222 228 Q 200 226 188 228 Z'},
  Stomach:         {pos:{x:268, y:248}, side:'R', size:0,  z:3, d:
    'M 256 234 L 260 234 L 262 248 Q 266 262 266 274 Q 264 282 256 284 Q 248 282 248 268 L 250 246 Q 251 238 256 234 Z'},
  Spleen:          {pos:{x:282, y:240}, side:'R', size:0,  z:2, d:
    'M 276 232 Q 286 230 288 242 Q 286 254 280 256 Q 272 246 274 234 Z'},
  Pancreas:        {pos:{x:258, y:272}, side:'R', size:0,  z:3, d:
    'M 266 268 Q 260 264 250 266 Q 240 268 234 272 Q 232 276 238 278 Q 248 276 256 274 Q 264 272 268 270 Q 270 266 266 268 Z'},

  Adrenal_Gland:   {pos:{x:240, y:250}, side:'R', size:0,  z:1, d:
    'M 194 248 Q 197 245 201 248 Q 199 252 195 252 Q 192 250 194 248 Z '+
    'M 279 248 Q 283 245 286 248 Q 288 252 284 252 Q 281 250 279 248 Z'},
  Kidney:          {pos:{x:240, y:262}, side:'L', size:0,  z:2, d:
    'M 190 254 Q 184 262 185 274 Q 190 282 196 280 Q 200 270 198 260 Q 194 252 190 254 Z '+
    'M 290 254 Q 296 262 295 274 Q 290 282 284 280 Q 280 270 282 260 Q 286 252 290 254 Z'},

  /* INTESTINES — compact, above pelvis (y < 350) */
  Small_Intestine: {pos:{x:246, y:308}, side:'L', size:0,  z:3, d:
    'M 252 296 Q 256 298 254 304 Q 248 306 244 302 Q 240 306 242 312 Q 246 316 250 314 Q 254 310 252 304 Z '+
    'M 244 314 Q 238 316 236 322 Q 238 328 244 328 Q 250 326 252 320 Q 250 316 244 314 Z '+
    'M 246 324 Q 252 326 252 332 Q 248 336 242 334 Q 238 330 240 326 Q 244 324 246 324 Z'},
  Colon:           {pos:{x:240, y:318}, side:'R', size:0,  z:2, d:
    'M 212 298 Q 204 308 204 322 Q 206 334 220 340 Q 240 342 258 340 Q 272 330 274 316 Q 272 302 262 298 Q 248 296 236 298 Q 220 298 212 298 Z'},

  /* PELVIS — small, within iliac crest */
  Bladder:         {pos:{x:240, y:348}, side:'R', size:0,  z:4, d:
    'M 234 346 Q 240 343 246 346 Q 247 350 240 351 Q 233 350 234 346 Z'},
  Uterus:          {pos:{x:240, y:342}, side:'L', size:0,  z:3, d:
    'M 232 336 Q 240 332 248 336 L 250 350 Q 240 354 230 350 Z'},
  Ovary:           {pos:{x:240, y:336}, side:'R', size:0,  z:3, d:
    'M 214 334 Q 210 335 211 339 Q 215 340 217 337 Z '+
    'M 266 334 Q 270 335 269 339 Q 265 340 263 337 Z '+
    'M 217 336 L 222 334 M 263 336 L 258 334'},
  Cervix:          {pos:{x:240, y:354}, side:'L', size:0,  z:3, d:
    'M 237 352 L 243 352 L 242 356 L 238 356 Z'},
  Prostate:        {pos:{x:240, y:346}, side:'R', size:0,  z:3, d:
    'M 234 344 Q 240 340 246 344 Q 247 348 240 349 Q 233 348 234 344 Z'},
  Testis:          {pos:{x:240, y:378}, side:'L', size:0,  z:3, d:
    'M 234 374 Q 228 380 234 384 Q 240 384 241 380 Q 242 384 246 384 Q 252 380 246 374 Q 243 373 240 378 Q 237 373 234 374 Z'},
